  ...
  projects: [
    ...
    },
    {
      ...
      details: [
        ...
        {
          label: 'My role',
          value: ['Front-end Developer', 'Mobile Developer', 'Designer'],
        },
      ...
      pdfDetails: [
        {
          label: 'Demo',
          value: 'https://tru-quest-ck7ea3.netlify.app',
          url: '#',
        },
        {
          label: 'Repository',
          value: 'https://github.com/mark-freeman/tru-quest',
          url: '#',
        },
      ],
      description:
    ...
    },
    {
      ...
      pdfDetails: [
        {
          label: 'Demo',
          value: 'https://software-chasers-e82l8e.netlify.app',
          url: '#',
        },
        {
          label: 'Repository',
          value: 'https://github.com/mark-freeman/software-chasers',
          url: '#',
        },
      ],
      description:
    ...
    },
    {
      ...
      pdfDetails: [
        {
          label: 'Demo',
          value: 'https://disco-ninjas-g321ol.netlify.app',
          url: '#',
        },
        {
          label: 'Repository',
          value: 'https://github.com/mark-freeman/disco-ninjas',
          url: '#',
        },
      ],
      description:
